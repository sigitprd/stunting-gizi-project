            ...
            <div class="container ">
             ...
             <!-- Project Card Example -->
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ url('/d_akun/'.auth()->user()->id).'/update' }}" method="post" autocomplete="off">
                      @method('patch')
                      @csrf
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="nama_anggota" class="bmd-label-floating">Nama Anggota</label>
                            <input type="text" id="nama_anggota" name="nama_anggota" class="form-control @error('nama_anggota') is-invalid @enderror" value="{{ old('nama_anggota', $anggota->nama_anggota) }}" required>
                            @error('nama_anggota') <div class="invalid-feedback">{{ $message }}</div>@enderror
                          </div>
                        </div>
                        <div class="col-md-8">
                          <div class="form-group">
                            <label class="bmd-label-floating">Jabatan : {{ $anggota->nama_jabatan }}</label>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <div class="custom-control custom-radio custom-control-inline">
                              <input required type="radio" class="custom-control-input @error('jenis_kelamin') is-invalid @enderror" id="customRadio" name="jenis_kelamin" value="Laki-Laki" {{ ($anggota->jenis_kelamin=="Laki-Laki")? "checked" : "" }} {{(old('jenis_kelamin') == 'Laki-Laki') ? 'checked' : ''}}>
                              <label class=" custom-control-label" for="customRadio">Laki-Laki</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                              <input required type="radio" class="custom-control-input @error('jenis_kelamin') is-invalid @enderror" id="customRadio2" name="jenis_kelamin" value="Perempuan" {{ ($anggota->jenis_kelamin=="Perempuan")? "checked" : "" }} {{(old('jenis_kelamin') == 'Perempuan') ? 'checked' : ''}}>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <textarea required class="form-control @error('alamat') is-invalid @enderror" id="alamat" placeholder="example jogjakarta" name="alamat">{{ old('alamat', $anggota->alamat) }}</textarea>
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nomor_hp') is-invalid @enderror" id="nomor_hp" name="nomor_hp" value="{{ old('nomor_hp', $anggota->nomor_hp) }}" required>
            ...
            <div class="container ">
             ...
             <!-- Project Card Example -->
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ url('/d_akun/'.auth()->user()->id).'/updateUser' }}" method="post" autocomplete="off">
                      @method('patch')
                      @csrf
                      <div class="row">
                        <div class="col-md-3">
