...
class KmsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($validator->passes())
        {
            ...
            $antopometris = Antopometri::where('jenis_kelamin', $balitas->jenis_kelamin)
                                        ->where('umur', $m)
                                        ->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validator->passes())
        {
            ...
            $balitas = Balita::find($kms->id_balita);

            $diff  = $kms->umur; //selisih umur
            ...
            Kms::where('id', $kms->id)
                ->update([
                    'berat_badan' => $nis,
                    'id_antopometri' => $antopometris->id,
                    'z_score' => $zscore,
